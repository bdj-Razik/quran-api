...
class SurahNumberController extends Controller
{
    /**
    ...
    public function __invoke($search)
    {
        ...
        return SurahResource::make(Surah::with('ayat')->where('number_of_surah', $search)->first());
